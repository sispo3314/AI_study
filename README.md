...
|---|---|
| Concepts | AI 및 딥러닝 기본 개념 정리 |
| Model Architectures | CNN, RNN, Transformer 등 모델 구조 정리 |
| Paper Reviews | 읽은 논문 요약 및 분석 |
| Implementations | PyTorch 구현 및 코드 실험 |
| Experiments | 모델 학습 결과, ablation, 실험 기록 |
| Lectures | 강의 및 스터디 필기 |
...
- [Transformer](https://encouraging-growth-39f.notion.site/Transformer-389358573e3680e2aa1cdc5bee4c696c?source=copy_link)
